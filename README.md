...
**Block library: 40 verified · 0 in progress · 48 targeted.** Full table → [`verification/STATUS.md`](verification/STATUS.md).
...
| **FSK4SlicerBlock** | `digital.constellation_decoder (M17 4FSK PAM, inverse of mapper)` | BER 0 (64 bits) |
