...
**Block library: 125 verified · 0 in progress · 125 targeted.** Full table → [`verification/STATUS.md`](verification/STATUS.md).
...
| **SVPWMBlock** | (Kyttar-native, no single GR block) | err 0 / tol 0 LSB |
| **CordicRotateBlock** | (Kyttar-native, no single GR block) | err 0 / tol 0 LSB |
<!-- BLOCK-STATUS:END -->
