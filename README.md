...
**Block library: 98 verified · 0 in progress · 108 targeted.** Full table → [`verification/STATUS.md`](verification/STATUS.md).
...
| **RaisedCosineEnvelopeBlock** | (Kyttar-native, no single GR block) | err 0 / tol 12 LSB |
...
| **DotProductMACBlock** | (Kyttar-native, no single GR block) | BER 0 (6 bits) |
