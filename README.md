...
**Block library: 30 verified · 0 in progress · 39 targeted.** Full table → [`verification/STATUS.md`](verification/STATUS.md).
...
| **RRCPulseShaperBlock** | `filter.fir_filter_fff` | err 4 / tol 34 LSB · -66 dB SNR |
...
| **PSKSymbolMapperBlock** | `digital.chunks_to_symbols_bf` | err 0 / tol 0 LSB |
