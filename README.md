...
**Block library: 44 verified · 0 in progress · 52 targeted.** Full table → [`verification/STATUS.md`](verification/STATUS.md).
...
| **QAM16ComplexCostasLoopBlock** | `digital.constellation_receiver_cb(constellation_16qam)` | — |
<!-- BLOCK-STATUS:END -->
