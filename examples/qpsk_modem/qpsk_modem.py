...
from gnuradio.kyttar import qpsk_demo_stim as stim
import sip
import threading
...
class qpsk_modem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Full-duplex QPSK modem (TX + coherent RX on one array)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Full-duplex QPSK modem (TX + coherent RX on one array)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_modem")
        ...
        self.slicer = kyttar.qpsk_slicer("kyttar_0")
