...
## INV-NEXT — A LOCK-rendezvous chip reports `stop_reason == "Deadlock"` for an arbiter-HELD word MID-GROUP while perfectly healthy; the diagnosis-bearing read is the run AFTER the group completes
