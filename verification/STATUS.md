...
**125 verified · 0 in progress · 125 targeted.** Each Kyttar block is verified as a drop-in equivalent of its GNU Radio Companion counterpart (same parameters, output matching within Q15 quantization). “Quality” is the measured error of the verified block versus the GNU Radio reference.
...
| **XorJoinBlock** | (Kyttar-native, no single GR block) | 1 · feed-forward | ✅ done | err 0 / tol 0 LSB | edge rand×3 mut |
...
| **GardnerTimingRecovery** | `digital.symbol_sync_cc` | 2 · stateful/loop | ✅ done | pass | edge rand×3 sweep×4 mut |
...
| **RaisedCosineEnvelopeBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 1 / tol 12 LSB | edge sweep×9 mut |
...
| **ClarkeTransformBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 0 / tol 0 LSB | edge rand×3 mut |
| **ChaCha20KeystreamBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 0 / tol 0 LSB | mut |
| **KeystreamSerializerBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 0 / tol 0 LSB | edge rand×3 |
...
| **SVPWMBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 0 / tol 0 LSB | edge rand×3 sweep×1 mut |
| **CordicRotateBlock** | (Kyttar-native, no single GR block) | 3 · new GRC block | ✅ done | err 0 / tol 0 LSB | edge rand×3 sweep×2 mut |
